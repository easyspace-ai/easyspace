      ...
      if (recordsResponse) {
        if (Array.isArray(recordsResponse)) {
          ...
          if (Array.isArray(recordsResponse.data)) {
            ...
            recordsResponse.data.list &&
            Array.isArray(recordsResponse.data.list)
          ) {
            recordsData = recordsResponse.data.list;
          }
        } else if (
          recordsResponse.list &&
          Array.isArray(recordsResponse.list)
        ) {
