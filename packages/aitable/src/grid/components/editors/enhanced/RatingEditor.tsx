 ...
 * Rating图标映射
 */
const RATING_ICON_COMPONENT: Record<
  string,
...
export const RatingEditor = forwardRef<HTMLDivElement, IRatingEditorProps>(
  (props, ref) => {
    ...
    const IconComponent =
      RATING_ICON_COMPONENT[icon] || RATING_ICON_COMPONENT.star;
