...
export interface IVirtualFieldConfigRef {
  show: (
    fieldType: "formula" | "rollup",
    initialOptions?: IFormulaFieldConfigOptions | IRollupFieldConfigOptions,
  ) => void;
  hide: () => void;
}
            ...
            <div>
              ...
              >
                <select
                  ...
                  onChange={(e) =>
                    setFormatting({ ...formatting, type: e.target.value })
                  }
                  style={{
                    padding: "8px 12px",
                    border: "1px solid #d1d5db",
                ...
                {ROLLUP_FUNCTIONS.map((func) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: "8px",
                      backgroundColor:
                        expression === func.value ? "#f0f9ff" : "white",
                      cursor: "pointer",
                      transition: "all 0.2s",
                      textAlign: "left",
                    }}
