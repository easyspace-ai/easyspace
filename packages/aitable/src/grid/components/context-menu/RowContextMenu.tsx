...
const RowContextMenuBase: ForwardRefRenderFunction<
  IRowContextMenuRef,
  IRowContextMenuProps
> = (props, ref) => {
  const {
    onDeleteRow,
    onDuplicateRow,
  ...
  return (
    <div
      ...
      style={{
        ...
        width: "max-content",
        opacity:
          computedPosition.left === 0 && computedPosition.top === 0 ? 0 : 1,
      }}
      ...
      {menuItems.map((item: any, index) => {
        ...
        return (
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = item.className?.includes(
                "red",
              )
                ? "#fef2f2"
                : "#f9fafb";
