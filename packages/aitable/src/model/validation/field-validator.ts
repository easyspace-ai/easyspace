...
export class FieldValidator {
    ...
    switch (fieldType) {
      ...
      case FIELD_TYPES.LongText:
        return this.validateTextValue(
          value,
          options as any,
        ) as ValidationResult<GetCellValue<T>>;
      ...
      case FIELD_TYPES.Checkbox:
        return this.validateCheckboxValue(value) as ValidationResult<
          GetCellValue<T>
        >;
      ...
      case FIELD_TYPES.Email:
        return this.validateEmailValue(value) as ValidationResult<
          GetCellValue<T>
        >;

      case FIELD_TYPES.Phone:
        return this.validatePhoneValue(value) as ValidationResult<
          GetCellValue<T>
        >;

      case FIELD_TYPES.URL:
        return this.validateURLValue(value) as ValidationResult<
          GetCellValue<T>
        >;
   ...
   */
  private static validateCheckboxValue(
    value: unknown,
   ...
   */
  private static validateEmailValue(
    value: unknown,
  ): ValidationResult<string | null> {
    const stringValue = safeString(value);
   ...
   */
  private static validatePhoneValue(
    value: unknown,
  ): ValidationResult<string | null> {
    const stringValue = safeString(value);
   ...
   */
  private static validateURLValue(
    value: unknown,
  ): ValidationResult<string | null> {
    const stringValue = safeString(value);
