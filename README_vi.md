...
Máy chủ demo 1 (Địa điểm: Washington, Hoa Kỳ): <https://show.easyspace.io>

Máy chủ demo 2 (Địa điểm: Tokyo, Nhật Bản): <https://demo.easyspace.io>

Để xem thêm tài liệu, hãy truy cập <https://document.easyspace.io>

## 🌟 Lịch sử Star

[![Biểu đồ lịch sử Star](https://app.repohistory.com/api/svg?repo=easyspace/easyspace&type=Timeline)](https://repohistory.com)

## 🚀 Bắt đầu

### 🖱 Mẫu một lần nhấp

[![Triển khai với Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Feasyspace%2Feasyspace&env=NEXT_PUBLIC_APP_URL,NEXTAUTH_URL,NEXTAUTH_SECRET,STRIPE_API_KEY,STRIPE_WEBHOOK_SECRET,POSTGRES_URL,GITHUB_CLIENT_ID,GITHUB_CLIENT_SECRET,RESEND_API_KEY,RESEND_FROM&install-command=bun%20install&build-command=bun%20run%20build&root-directory=apps%2Fnextjs)
...
Bạn có thể tìm thấy mã triển khai NextAuth ở đây ( https://github.com/easyspace/easyspace/tree/feature-nextauth ).
...
1. Trang tổng quan quản trị (vẫn đang trong giai đoạn alpha!!!)
    ...
    3. Bạn có thể cung cấp một tài khoản quản trị viên, thay đổi **ADMIN_EMAIL="admin@easyspace.io,root@easyspace.io"** trong .env.local, sau đó truy cập host:port/admin/dashboard
