...
演示服务器1(位置:美国华盛顿): <https://show.easyspace.io>

演示服务器2(位置:日本东京): <https://demo.easyspace.io>

查看更多文档请访问 <https://document.easyspace.io>
...
你可以在这里找到 NextAuth 的实现方案 （ https://github.com/easyspace/easyspace/tree/feature-nextauth ）。

## 🥺 项目路线图

1. 管理仪表板页面(处于alpha阶段!!!)
    2. 目前仅提供静态页面,我们计划与无头架构CMS集成
    3. 您可以提供管理员账号,在.env.local中更改**ADMIN_EMAIL="admin@easyspace.io,root@easyspace.io"**,然后访问host:port/admin/dashboard
