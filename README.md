...
<div align="center" width="100%">
    <img src="./easyspace-logo.svg" width="128" alt="" />
</div>

# Saasfly </br>
<a href="https://trendshift.io/repositories/8929" target="_blank"><img src="https://trendshift.io/api/badge/repositories/8929" alt="easyspace%2Feasyspace | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
...
![COMMIT_ACTIVITY](https://img.shields.io/github/commit-activity/m/easyspace/easyspace?style=for-the-badge">)
[![Visitors](https://api.visitorbadge.io/api/visitors?path=https%3A%2F%2Fgithub.com%2Feasyspace%2Feasyspace&labelColor=%23f47373&countColor=%23263759)](https://visitorbadge.io/status?path=https%3A%2F%2Fgithub.com%2Feasyspace%2Feasyspace)
...
Demo Server (Location: Washington - USA): <https://show.easyspace.io>

See more documentation at <https://document.easyspace.io>

## 🌟 Star History

[![Star History Chart](https://app.repohistory.com/api/svg?repo=easyspace/easyspace&type=Timeline)](https://repohistory.com)
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Feasyspace%2Feasyspace&env=NEXT_PUBLIC_APP_URL,NEXTAUTH_URL,NEXTAUTH_SECRET,STRIPE_API_KEY,STRIPE_WEBHOOK_SECRET,POSTGRES_URL,GITHUB_CLIENT_ID,GITHUB_CLIENT_SECRET,RESEND_API_KEY,RESEND_FROM&install-command=bun%20install&build-command=bun%20run%20build&root-directory=apps%2Fnextjs)
...
```bash
bun create easyspace 
```

2. Manually clone the repository:

```bash
git clone https://github.com/easyspace/easyspace.git
cd easyspace
bun install
```
...
You can find the NextAuth implementation here ( https://github.com/easyspace/easyspace/tree/feature-nextauth ) .
...
1. Admin Dashboard Page (in alpha !!!)
    ...
    2. You can provide your admin account and change **ADMIN_EMAIL="admin@easyspace.io,root@easyspace.io"** in .env.local and access host:port/admin/dashboard
...
<a href="https://github.com/easyspace/easyspace/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=easyspace/easyspace" />
</a>
...
[check-workflow-badge]: https://img.shields.io/github/actions/workflow/status/easyspace/easyspace/ci.yml?label=ci
[github-license-badge]: https://img.shields.io/badge/License-MIT-green.svg
[discord-badge]: https://img.shields.io/discord/1204690198382911488?color=7b8dcd&link=https%3A%2F%2Feasyspace.io%2Fdiscord
[made-by-nextify-badge]: https://img.shields.io/badge/made_by-nextify-blue?color=FF782B&link=https://nextify.ltd/

[check-workflow-badge-link]: https://github.com/easyspace/easyspace/actions/workflows/check.yml
[github-license-badge-link]: https://github.com/easyspace/easyspace/blob/main/LICENSE
