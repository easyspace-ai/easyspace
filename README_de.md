...
Demo-Server 1 (Standort: Washington, USA): <https://show.easyspace.io>

Demo-Server 2 (Standort: Tokio, Japan): <https://demo.easyspace.io>

Weitere Dokumentation finden Sie unter <https://document.easyspace.io>.
...
Hier finden Sie die NextAuth Implementierung ( https://github.com/easyspace/easyspace/tree/feature-nextauth ).
...
1. Admin-Dashboard-Seite (in Alpha!!!)
   ...
   3. Sie können Ihr Admin-Konto angeben, indem Sie **ADMIN_EMAIL="admin@easyspace.io,root@easyspace.io"** in .env.local ändern und auf host:port/admin/dashboard zugreifen
